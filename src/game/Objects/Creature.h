...
class Creature : public Unit
{
    ...
    public:
        ...
        float _GetHealthMod(int32 rank) const;              // Get custom factor to scale health (default 1, CONFIG_FLOAT_RATE_CREATURE_*_HP)
        float _GetDamageMod(int32 rank) const;              // Get custom factor to scale damage (default 1, CONFIG_FLOAT_RATE_*_DAMAGE)
        float _GetSpellDamageMod(int32 rank) const;         // Get custom factor to scale spell damage (default 1, CONFIG_FLOAT_RATE_*_SPELLDAMAGE)
