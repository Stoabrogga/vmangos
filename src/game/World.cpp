...
void World::LoadConfigSettings(bool reload)
{
    ...
    setConfig(CONFIG_BOOL_AMMO_LOSS_ENABLE, "AmmoLoss.Enable", true);
    ...
    setConfig(CONFIG_BOOL_ACTIVE_WAYPOINT_MOVEMENT, "ActiveWaypointMovement", false);
    ...
    setConfig(CONFIG_BOOL_CREATURE_DAZE, "CreatureDaze", true);
    ...
    setConfig(CONFIG_BOOL_PET_SYNC_LEVEL, "PetSyncLevel", false);
    ...
    setConfigMin(CONFIG_FLOAT_PET_XP_FACTOR, "PetXPFactor", 1.f, 0.f);
    setConfigMin(CONFIG_FLOAT_PET_AOE_FACTOR, "PetAoeFactor", 1.f, 0.f);
    ...
    setConfig(CONFIG_UINT32_PARTY_BOT_RANDOM_GEAR_MIN_ITEM_LEVEL_AT_MAX_PLAYER_LEVEL, "PartyBot.RandomGearMinItemLevelAtMaxPlayerLevel", 0);
