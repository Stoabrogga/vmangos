...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_INTERVAL_CHANGEWEATHER_MIN,
    CONFIG_UINT32_INTERVAL_CHANGEWEATHER_MAX,
    ...
    CONFIG_UINT32_RAID_SCALING_HP,
    CONFIG_UINT32_BLACKWING_LAIR_RAZORGORE_EGG_COUNT,
    CONFIG_UINT32_NAXXRAMAS_GOTHIK_CHECK_PLAYER_COUNT,
    CONFIG_UINT32_PET_RESISTANCE,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_HEALTH_CREATURE,
    CONFIG_FLOAT_RATE_HEALTH_PET,
    ...
    CONFIG_FLOAT_RATE_POWER_MANA_CREATURE,
    CONFIG_FLOAT_RATE_POWER_MANA_PET,
    ...
    CONFIG_FLOAT_PET_XP_FACTOR,
    CONFIG_FLOAT_PET_AOE_FACTOR,
    CONFIG_FLOAT_RATE_CREATURE_RAID_DAMAGE,
    CONFIG_FLOAT_RATE_CREATURE_RAID_SPELLDAMAGE,
    CONFIG_FLOAT_PET_HEALTH_FACTOR,
    CONFIG_FLOAT_PET_DAMAGE_FACTOR,
    CONFIG_FLOAT_PET_ARMOR_FACTOR,
    CONFIG_FLOAT_PET_MANA_FACTOR,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_NAXXRAMAS_GOTHIK_KEEP_DOOR_OPEN,
    CONFIG_BOOL_AMMO_LOSS_ENABLE,
    CONFIG_BOOL_ACTIVE_WAYPOINT_MOVEMENT,
    CONFIG_BOOL_CREATURE_DAZE,
